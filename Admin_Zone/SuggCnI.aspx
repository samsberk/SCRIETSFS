<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SuggCnI.aspx.cs" Inherits="Admin_Zone_SuggCnI" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Suggestion for College & Infrastructure : SCRIET Student Feedback System</title>
    ...
    <form id="form1" runat="server">
		...
		<div class="panel-body" style="min-height:100vh;padding:0px;border:none;">
			<div class="side-menu">
				...
				<a href="Suggestions_for_College_and_Infrastructure" class="click-on"><span class="glyphicon glyphicon-comment now-open" data-toggle="tooltip" data-placement="right" title="SUBMITTED SUGGESTIONS FOR COLLEGE & INFRASTRUCTURE"></span></a>
			...
			<div class="side-menu-box">
				<div class="panel-body" style="overflow-x:auto;"><br />
					<h4><span class="glyphicon glyphicon-comment"></span> Students Suggestions for College & Infrastructure :</h4><hr/>
					<table border="1" style="width:100%;">
                        <tr><th>Sr.No.</th><th>Department/Branch/Year</th><th>Suggestion</th><th>Suggestion_Date</th></tr>
                        <asp:PlaceHolder ID="cigen" runat="server"></asp:PlaceHolder>
                    </table>
				</div>
			</div>
		</div><br />
