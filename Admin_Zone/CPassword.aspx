<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CPassword.aspx.cs" Inherits="Admin_Zone_CPassword" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Admin Change Passowrd : SCRIET Student Feedback System</title>
    ...
    <form id="form1" runat="server">
		...
		<div class="panel-body" style="min-height:100vh;padding:0px;border:none;">
			<div class="side-menu">
				...
				<a href="Change_Password_Admin" class="click-on"><span class="glyphicon glyphicon-lock now-open" data-toggle="tooltip" data-placement="right" title="RESET PASSWORD"></span></a>
