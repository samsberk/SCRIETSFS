<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SuggTnC.aspx.cs" Inherits="Admin_Zone_SuggTnC" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Suggestion for Teaching & Curriculum : SCRIET Student Feedback System</title>
    ...
    <form id="form1" runat="server">
		...
		<div class="panel-body" style="min-height:100vh;padding:0px;border:none;">
			<div class="side-menu">
				...
				<a href="Suggestions_for_Teaching_and_Curriculum" class="click-on"><span class="glyphicon glyphicon-comment now-open" data-toggle="tooltip" data-placement="right" title="SUBMITTED SUGGESTIONS FOR TEACHING & CURRICULUM"></span></a>
			...
			<div class="side-menu-box">
				<div class="panel-body"><br />
					<h4><span class="glyphicon glyphicon-comment"></span> Students Suggestions for Teaching & Curriculum :</h4><br />
					<table border="1" style="width:100%;">
                        <tr><th>Sr.No.</th><th>Department/Branch/Year</th><th>Suggestion</th><th>Suggestion_Date</th></tr>
                        <asp:PlaceHolder ID="tcgen" runat="server"></asp:PlaceHolder>
                    </table>
				</div>
			</div>
		</div><br />
