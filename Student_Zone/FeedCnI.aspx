<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FeedCnI.aspx.cs" Inherits="Student_Zone_FeedCnI" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Feedback About College & Infrastructure : SCRIET Student Feedback System</title>
...
<body>
		...
		<div class="panel-body will-hide" style="padding-top:65px;min-height:100vh;">
            <div class="panel panel-primary" style="border:none;">
                <div class="panel-body" style="font-size:17px;">
                    <h3 style="">Feedback from You About College & Infrastructure <span class="glyphicon glyphicon-comment"></span> </h3><hr />
                    <p style="text-align:justify;"><b>Dear <asp:Label ID="udname" runat="server"></asp:Label>,</b><br />
                    ...
                    <p><b>Directions:</b> For each item please indicate your level of agreement with the following statements by selecting appropriate option.</p>
                    <br />
                    <p style="color:red;">
                    ...
                    <p><b>1. The office staff in the college is cooperative and helpful :</b></p>
                    <div class="row">
                    ...
                    <p><b>2. The library staff is cooperative and helpful :</b></p>
                    <div class="row">
                    ...
                    <p><b>3. Online educational resources are available and accessible in the library :</b></p>
                    <div class="row">
                    ...
                    <p><b>4. Internet facility provided in the Library is satisfactory :</b></p>
                    <div class="row">
                    ...
                    <p><b>5. The prescribed books / reading materials are available in the library :</b></p>
                    <div class="row">
                    ...
                    <p><b>6. Equipment in the lab(s) is in good working condition :</b></p>
                    <div class="row">
                    ...
                    <p><b>7. Results are displayed by the college :</b></p>
                    <div class="row">
                    ...
                    <p><b>8. Separate common rooms for girls and boys are available :</b></p>
                    <div class="row">
                    ...
                    <p><b>9. Toilets / washrooms are clean and properly maintained :</b></p>
                    <div class="row">
                    ...
                    <p><b>10. The classrooms are clean and well maintained :</b></p>
                    <div class="row">
                    ...
                    <p><b>11. The campus is green and eco-friendly :</b></p>
                    <div class="row">
                    ...
                    <p><b>12. Clean drinking water is available in the college campus :</b></p>
                    <div class="row">
                    ...
                    <p><b>13. The buildings / classrooms are accessible to disabled persons :</b></p>
                    <div class="row">
                    ...
                    <p><b>14. The campus has adequate power supply :</b></p>
                    <div class="row">
                    ...
                    <p><b>15. Our grievances are redressed / problems are solved well in time :</b></p>
                    <div class="row">
                    ...
                    <p><b>16. The functioning of the placement cell in the college is satisfactory:</b></p>
                    <div class="row">
                        <div class="col-sm-2 mycol5"><asp:RadioButton ID="cifunplace1" runat="server" CssClass="myrdobtn" GroupName="ci16" Text="&ensp;Strongly Agree" /></div>
                        <div class="col-sm-2 mycol5"><asp:RadioButton ID="cifunplace2" runat="server" CssClass="myrdobtn" GroupName="ci16" Text="&ensp;Agree" /></div>
                        <div class="col-sm-2 mycol5"><asp:RadioButton ID="cifunplace3" runat="server" CssClass="myrdobtn" GroupName="ci16" Text="&ensp;Not Sure" /></div>
                        <div class="col-sm-2 mycol5"><asp:RadioButton ID="cifunplace4" runat="server" CssClass="myrdobtn" GroupName="ci16" Text="&ensp;Disagree" /></div>
                        <div class="col-sm-3 mycol5"><asp:RadioButton ID="cifunplace5" runat="server" CssClass="myrdobtn" GroupName="ci16" Text="&ensp;Strongly Disagree" /></div>
                    </div><br /><br />
                    <div class="row">
	...
	<script>
        ...
        $("#agrtnc").bind("change", function () {
            ...
            var q161 = document.getElementById("cifunplace1");
            var q162 = document.getElementById("cifunplace2");
            var q163 = document.getElementById("cifunplace3");
            var q164 = document.getElementById("cifunplace4");
            var q165 = document.getElementById("cifunplace5");
            if (chk.checked == true) {
                ...
                else if (q161.checked != true && q162.checked != true && q163.checked != true && q164.checked != true && q165.checked != true) {
                    alert("Please Choose any Option for Question No: 16");
                    chk.checked = false;
                }
                else {
