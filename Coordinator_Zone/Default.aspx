<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Coordinator_Zone_Default" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Coordinator Home : SCRIET Student Feedback System</title>
...
<body>
    ...
    <form id="form1" runat="server">
		...
		<div class="panel-body" style="min-height:100vh;padding:0px;border:none;">
			<div class="side-menu">
				<a href="Coordinator_Home" class="click-on"><span class="glyphicon glyphicon-th now-open" style="border-top:1px solid gray;padding-left:20%;" data-toggle="tooltip" data-placement="right" title="DASHBOARD"></span></a>
			...
			<div class="side-menu-box">
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-sm-10">
							<a href="Student_Verification_Management" class="link click-on">
								<div class="info-box">
									<span class="glyphicon glyphicon-saved info-box-icon"></span>
									<h4>Manage Student Feedback Verification</h4>
								</div>
							</a>
						</div>
						<div class="col-sm-1"></div>
					...
					<div class="row">
						<div class="col-sm-1"></div>
						<div class="col-sm-5">
							<a href="Change_Password" class="link click-on">
								<div class="info-box">
						...
						<div class="col-sm-5">
							<a href="Coordinator_Logout" class="link click-on">
								<div class="info-box">
